...
#### The aim of this website is to in an easy and intuitive way present useful and crucial information to people living in a building owned by Lomsten. 
...
The personas main goal is to find information about building so that know how I should relate, locate and act within the building. Their agespan is supposted to be between 25 and 45 years old.

#### Being more specific 
- As a tenant i want to have a website so that....
 1.  I can find information to who to call if i have question or need to solve an issue </br>
 2. I can see what is included in the rent <br/>
 3. I know where I can find assets such as storage, laundary etc..<br/>
 4. I know how I should act in different situation <br/>
5. how I should act in different situations (eg. when to turn done music, if it is allowed to refurbushing the apartment etc..) <br/>
6. I know if there is something happening that will affect my living<br/>
7. I can find Forms, Blueprint, Invoice, Contract connected to the living so I know how to act in different situations (what is needed to been done when moving in or moving out, when to pay the bill, what is agree upon in the contract etc..) <br/>
8. I can find information about the neighbourhood so I know where to go if I want to shop, eat, park the car etc..

 - As a constructor our as on other constructor i want to have a website so that....
 1.  I can find information to who to call if i have question or need to solve an issue </br>
...
-----------------------|------------|----------------------|
Create an responsive webpage|5|4
...
#### Because the score in Viability/Feasibility and Importance do not add up, decisions on what to implement has to be made
#### For the first prototype following is prioritized

1. The design should be clean, intuative and responsive
...
4. The final prototype should deployed on GITHUB masterbransch

### Wireframe 
[Large Media Devices](assets/documents/MP1en.pdf "Wireframe homepage")
...
5. Contruct a form for report an issue
